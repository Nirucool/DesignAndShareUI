            ...
            <div>
                <MuiThemeProvider>
                    <AppBar style={{backgroundColor: 'black'}}
                            title={<img src={header} style={{marginLeft: '200px', "width": '150px', "height": '20px'}}
                                        alt="Logo"/>}
                            onLeftIconButtonClick={this.handleDrawerClick.bind(this)}>

                        <Collapse isOpen={this.state.isOpen}>
                            <UncontrolledDropdown style={{marginRight: '200px', color: 'white', fontSize: '12px'}}>
                        ...
                        <Drawer open={this.state.open}>
                            ...
                            <MenuItem><a className="nav-link" href="/patioDesign"
                                         style={{color: 'black', backgroundColor: '#17a2b8'}}>Patio
                                Design</a></MenuItem>
                            <MenuItem><a className="nav-link" href="/bedroomDesign"
                                         style={{color: 'white', backgroundColor: 'black'}}>Bedroom
                                Design</a></MenuItem>
                            <MenuItem><a className="nav-link" href="/kitchenDesign"
                                         style={{color: 'black', backgroundColor: '#17a2b8'}}>Kitchen
                                Design</a></MenuItem>
                            <MenuItem><a className="nav-link" href="/kitchenGardenDesign"
                                         style={{color: 'white', backgroundColor: 'black'}}>Kitchen Garden
                                Design</a></MenuItem>
                            <MenuItem><a className="nav-link" href="/kidsRoomDesign"
                                         style={{color: 'black', backgroundColor: '#17a2b8'}}>Kids Room
                                Design</a></MenuItem>
                            <MenuItem><a className="nav-link" href="/livingRoomDesign"
                                         style={{color: 'white', backgroundColor: 'black'}}>Living Room
                                Design</a></MenuItem>
